...
class Payment_Adapter_Paylane implements \Box\InjectionAwareInterface
{
    ...
    {
        $config['return_url'] = 'http://localhost:8888/invoice/hash'; 
        $config['cancel_url'] = 'http://localhost:8888/invoice/hash'; 
        $config['notify_url'] = 'http://localhost:8888/bb-ipn.php'; 
        $config['redirect_url'] = 'http://localhost:8888/bb-ipn.php?bb_redirect=1&bb_invoice_hash=invoice_hash';
        $config['continue_shopping_url'] = 'http://localhost:8888/order';
    ...
    private function serviceUrl()
    {
        if($this->config['test_mode']) {
            return 'https://direct.paylane.com/rest/';
        } else {
            return 'https://direct.paylane.com/rest/';
        }
    }
